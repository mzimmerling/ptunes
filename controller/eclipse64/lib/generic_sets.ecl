...
% Version:	$Id: generic_sets.ecl,v 1.2.2.2 2009/11/20 05:51:01 jschimpf Exp $
%
...
intset(_X{int_sets:Attr}, MinUniv, MaxUniv) ?- nonvar(Attr), !,
...
:- comment(date, "$Date: 2009/11/20 05:51:01 $").
