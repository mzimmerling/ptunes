...
update_alldifferent_matrix(List,Matrix,Susp):-
        call_priority(update_alldifferent_matrix1(List,Matrix,Susp),2).

update_alldifferent_matrix1(List,Matrix,Susp) :-
        check_alldifferent_matrix(Matrix),
        (ground(List) ->
...
update_gcc_matrix(List,Matrix,Limits,Susp):-
        call_priority(update_gcc_matrix1(List,Matrix,Limits,Susp),2).

update_gcc_matrix1(List,Matrix,Limits,Susp) :-
...
update_inverse(Variables,Vars1,Vars2,N,Susp):-
        call_priority(update_inverse1(Variables,Vars1,Vars2,N,Susp),2).

update_inverse1(Variables,Vars1,Vars2,N,Susp) :-
        check_inverse(Vars1,Vars2,N),
        (ground(Variables) ->
            kill_suspension(Susp)
        ;
