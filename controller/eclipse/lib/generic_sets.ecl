...
% Version:	$Id: generic_sets.ecl,v 1.2.2.1 2009/03/14 07:50:38 jschimpf Exp $
%
...
impose_set_bounds(X{int_sets:SetAttr}, Lwb, Upb) ?- nonvar(SetAttr), !,
...
:- comment(date, "$Date: 2009/03/14 07:50:38 $").
